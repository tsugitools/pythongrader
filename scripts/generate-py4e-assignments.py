...
EXERCISES = [
    ...
    },
    {
        ...
        "prompt": "<b>11.9</b> Write a program to prompt the user for a regular expression and read through <b>mbox-short.txt</b> and count the number of lines that match the regular expression using re.search().",
        "checks": {
            "for": "You need a for loop to read the lines in the file.",
